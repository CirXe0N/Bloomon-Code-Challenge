...
def planner():
    ...
    planner.add_design(name='Z', size='S', total_quantity=3, flowers={
        'a': 2,
        'b': 2
    })
    return planner
...
@pytest.mark.parametrize('flower_data,expected_result', [
...
@pytest.mark.parametrize('flowers,amounts_left,expected', [
